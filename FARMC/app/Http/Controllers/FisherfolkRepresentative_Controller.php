...
class FisherfolkRepresentative_Controller extends Controller
{
    public function createFisherfolkRep(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'endorsement_attachment' => 'file|max:2048|mimes:pdf,doc,docx',
            'aoy_attachment' => 'file|max:2048|mimes:pdf,doc,docx',
            'soi_attachment' => 'file|max:2048|mimes:jpeg,png',
            'gmc_attachment' => 'file|max:2048|mimes:jpeg,png',
            'dor_file' => 'file|max:2048|mimes:pdf,doc,docx',
            'doa_file' => 'file|max:2048|mimes:pdf,doc,docx',
        ], [
            'endorsement_attachment.max' => 'The endorsement_attachment file may not be greater than 2MB.',
            'aoy_attachment.max' => 'The aoy_attachment file may not be greater than 2MB.',
            'soi_attachment.max' => 'The soi_attachment file may not be greater than 2MB.',
            'gmc_attachment.max' => 'The gmc_attachment file may not be greater than 2MB.',
            'dor_file.max' => 'The dor_file file may not be greater than 2MB.',
            'doa_file.max' => 'The doa_file file may not be greater than 2MB.',
            'endorsement_attachment.mimes' => 'The endorsement_attachment file must be a file of type: pdf, doc, docx.',
            'aoy_attachment.mimes' => 'The aoy_attachment file must be a file of type: pdf, doc, docx.',
            ...
            'dor_file.mimes' => 'The dor_file file must be a file of type: pdf, doc, docx.',
            'doa_file.mimes' => 'The doa_file file must be a file of type: pdf, doc, docx.',
        ]);
