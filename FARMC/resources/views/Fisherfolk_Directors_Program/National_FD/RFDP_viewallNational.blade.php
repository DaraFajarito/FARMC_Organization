...
<head>
    <title>National FD | Fisherfolk Directors Program | View All | BFAR - FARMC</title>
            ...
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="#!"> National Fisherfolk Director </a>
                        </li>
                    ...
                    <div style="display: flex;">
                        <a href="{{ url('/nationalFD') }}" class="btn btn-secondary"> <i
                                ...
                                <div class="tab-pane active" id="members" role="tabpanel">
                                    ...
                                    <table id="FARMC" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <tbody style="font-size:11px">
                                            @foreach ($RFDPviewNational as $item)
