...
<head>
    <title>Regional FD | Fisherfolk Directors Program | View All | BFAR - FARMC</title>
            ...
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="#!"> Regional Fisherfolk Director </a>
                        </li>
                    ...
                    <div style="display: flex;">
                        <a href="{{ url('/regionalFD') }}" class="btn btn-secondary"> <i
                                ...
                                <div class="tab-pane active" id="members" role="tabpanel">
                                    ...
                                    <table id="FARMC" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <tbody style="font-size:11px">
                                            @foreach ($RFDPviewRegionalFD as $item)
                                                @if ($item->status != 'ARCHIVED')
                                                    <tr>
                                                        ...
                                                        <td style=" display: flex; justify-content: space-between;">
                                                            ...
                                                            <a href="{{ url('/archived_RFD/' . $item->id) }}"
