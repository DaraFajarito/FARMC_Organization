                    ...
                    <div class="row dashboard-header">
                        <div class="col-lg-6 col-md-6">
                            <div class="card dashboard-product">
                                ...
                                <span>Regional Fisherfolk Directors</span>
                                <h2 class="dashboard-total-products">{{$RFDMemCount}}</h2>
                                <div class="side-box ">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card dashboard-product">
                                ...
                                <h2 class="dashboard-total-products">{{$RFDOrgCount}}</h2>
                                <div class="side-box ">
                                            ...
                                            <tr>
                                                ...
                                                <td style=" display: flex; justify-content: space-between;">
                                                    ...
                                                    <a href="{{ url ('/rfdp_edit/'. $item->id)}}" class="btn btn-warning"><i
                                                            class="ti-pencil"></i></a>
                                                    <a href="{{ url ('/archived_RFD/'. $item->id)}}" class="btn btn-danger"><i
                                                            class="ti-trash"></i></a>
                                                </td>
                                            </tr>
                                            @endif
