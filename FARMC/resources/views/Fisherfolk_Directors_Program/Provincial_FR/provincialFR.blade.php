...
<head>
    <title>Provincial Fisherfolk Representative Overview | BFAR - FARMC</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="tabs.html">Provincial Fisherfolk Representative</a>
                        </li>
                    </ol>
            ...
            <div class="col-md-12" style="margin-bottom: 30px;">
                <a href="{{ url('/archived_PFR') }}"><button type="button" class="btn btn-warning"><i
                            class="ti-archive"></i> Archived Members</button></a>
                <a href="{{ url('/viewall_Provincial') }}"><button type="button" class="btn btn-primary"
