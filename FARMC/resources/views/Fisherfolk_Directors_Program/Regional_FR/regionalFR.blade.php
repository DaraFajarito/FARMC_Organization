...
<head>
    <title>Regional Fisherfolk Representative Overview | BFAR - FARMC</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="tabs.html">Regional Fisherfolk Representative</a>
                        </li>
                    </ol>
                    ...
                    <div class="row dashboard-header">
                        <div class="col-lg-6 col-md-6">
                            <div class="card dashboard-product">
                                ...
                                <span>Regional Fisherfolk Representative</span>
                                <h2 class="dashboard-total-products">{{ $RFRMemCount }}</h2>
                                <div class="side-box ">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card dashboard-product">
                                ...
                                <h2 class="dashboard-total-products">{{ $RFROrgCount }}</h2>
                                <div class="side-box ">
            ...
            <div class="col-md-12" style="margin-bottom: 30px;">
                <a href="{{ url('/archived_RFR') }}"><button type="button" class="btn btn-warning"><i
                            class="ti-archive"></i> Archived Members</button></a>
                <a href="{{ url('/viewall_RegionalFR') }}"><button type="button" class="btn btn-primary"
