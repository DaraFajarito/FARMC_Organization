        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-header">
                    <h4>Level Two Overview</h4> | <span class="label label-primary">Basic Function of the FARMC</span>
                   ...
                   <div class="card-block">
                    ...
                    <div class="card-block">
                        <div class="row">
                            ...
                            <a href="{{ url ('/L2Completed') }}"><button type="button" class="btn btn-primary">All Completed</button></a>
                            <a href="{{ url ('/L2Incomplete') }}"><button type="button" class="btn btn-danger">All Incomplete</button></a>
                            </div>
                        </div>
                    </div>
