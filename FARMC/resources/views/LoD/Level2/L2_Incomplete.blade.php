                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ url('/L2Editform') }}" class="btn btn-danger"><i class="ti-write"></i>
                                        &nbsp; Edit form</a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @if (in_array('mfdp', $basicFunctionNull) || $basicFunction->mfdp === 'Formulated')
                                            <b><i class="ti-check-box text-danger-color"></i></b>
                                            <span style="display: inline-block;">&nbsp; Municipal Fisheries Development
                                                Plan (MFDP) </span>
                                        @endif
                                        ...
                                        @if (in_array('copy1_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; MFDP Copy file</span>
                                        @endif
                                        <br>
                                        @if (in_array('mindoc1_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; MFDP Minutes / Documents</span>
                                        @endif
                                        <br>
                                        @if (in_array('mfo', $basicFunctionNull) || $basicFunction->mfo === 'Formulated')
                                            <b><i class="ti-check-box text-danger-color"></i></b>
                                            <span style="display: inline-block;">&nbsp; Municipal Fisheries
                                                Ordinance</span>
                                        @endif
                                        <br>
                                        @if (in_array('copy2_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; MFO Copy file</span>
                                        @endif
                                        <br>
                                        @if (in_array('mindoc2_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; MFO Minutes or Documents</span>
                                        @endif
                                        <br>
                                        <br>
                                        <div>
                                        ...
                                        @if (in_array('bantaydt', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With Bantay Dagat Taskforce</span>
                                        @endif
                                        <br>

                                        @if (in_array('bantaydt_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With Bantay Dagat Taskforce
                                                (List)</span>
                                        @endif
                                        <br>
                                        ...
                                        @if (in_array('actfarmcbt', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With list of activity undertaken
                                                by the FARMC-Bantay Dagat</span>
                                        @endif
                                        <br>
                                        @if (in_array('actfarmcbt_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With list of activity undertaken
                                                by the FARMC-Bantay Dagat (List)</span>
                                        @endif
                                        <br>
                                        @if (in_array('appfarmcbt', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With list of apprehention
                                                conducted by the FARMC-Bantay Dagat</span>
                                        @endif
                                        <br>
                                        @if (in_array('appfarmcbt_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With list of apprehention
                                                conducted by the FARMC-Bantay Dagat (List)</span>
                                        @endif
                                        @if (in_array('caseestablished', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With list of cases established and
                                                functional</span>
                                        @endif
                                        <br>
                                        ...
                                        @if (in_array('mfarmcoffice', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With MFARMC Office Established And
                                                Functional</span>
                                        @endif
                                        <br>
                                        @if (in_array('copy3_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; With MFARMC Office Established And
                                                Functional (Photo of Office)</span>
                                        @endif
                                        <br>
                                        @if (in_array('regmeet', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; Conduct regular meeting
                                                (monthly/quarterly)</span>
                                        @endif
                                        <br>
                                        @if (in_array('minatt_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; Regular meeting (minutes of
                                                attendance) </span>
                                        @endif
                                        <br>
                                        @if (in_array('photodoc_file', $basicFunctionNull))
                                            <b> <i class="ti-check-box text-danger-color"></i></b><span
                                                style="display: inline-block;">&nbsp; Regular meeting (Photo
                                                Documentation)</span>
                                        @endif
                                        <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a href="{{ url('/L2Incompletetbl') }}"> <button type="submit"
