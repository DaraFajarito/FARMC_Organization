                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-right">
                                        <a href="{{ url('/L5Completedtbl') }}"><button type="button"
                                                class="btn btn-primary">All Completed</button></a>
                                        <a href="{{ url('/L5Incompletetbl') }}"><button type="button"
                                                class="btn btn-danger">All Incomplete</button></a>
                                        <a href="{{ url('/L5Archivedtbl') }}"><button type="button"
                                                    ...
                                                    <table id="FARMC" class="table table-striped table-bordered"
                                                        ...
                                                        <thead style="font-size:10px">
                                                            <tr>
                                                                <th>Province</th>
                                                                <th>Municipality</th>
                                                                <th>List Of Governing Bodies That Recognises The MFARMC
                                                                    As A Member</th>
                                                                <th>Plaque Of Recognition Received</th>
                                                                <th>Certificate Of Merit, Recognition And Appreciation
                                                                    Received</th>
                                                                <th>Status</th>
                                                                <th>Action</th>
                                                            </tr>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-block">
                                        <h6 class="card-title">All Level 5 <em> <small>(Incomplete &
                                                    Complete)</small></em></h6>
                                        <div class="row">
