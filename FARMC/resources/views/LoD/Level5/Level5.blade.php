                   ...
                   <div class="card-block">
                    ...
                    <div class="card-block">
                        <div class="row">
                            ...
                            <a href="{{ url ('/L5Completed') }}"><button type="button" class="btn btn-primary">All Completed</button></a>
                            <a href="{{ url ('/L5Incomplete') }}"><button type="button" class="btn btn-danger">All Incomplete</button></a>
                            </div>
                        </div>
                    </div>
