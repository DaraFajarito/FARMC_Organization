...
<head>
    <title> Youth Fisherfolk - Fisherfolk Organization | BFAR - FARMC</title>
            ...
            <div class="row">
                <div class="main-header">
                    ...
                    <span style="display: inline-block; vertical-align: middle; margin-top:10px">
                        <div>
                            <h4 style="margin: 0;">Youth Fisherfolk</h4>
                        </div>
                    </span>
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="tabs.html"> Youth Fisherfolk</a>
                        </li>
                    ...
                    <div class="row dashboard-header">
                        <div class="col-lg-112 col-md-12">
                            <div class="card dashboard-product">
                                ...
                                <span>Youth Fisherfolk Members</span>
                        ...
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-right">
                                    <a href="{{ url('/archived_Youth') }}"><button type="button"
                                            class="btn btn-danger">All Archived</button></a>
                                    <a href="{{ url('/viewallYouth') }}"><button type="button"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td
                                                                    ...
                                                                    <a href="{{ url ('/association_edit/' . $item->id)}}" class="btn btn-warning"><i
                                                                            class="ti-pencil"></i></a>
                                                                    <a href="{{ url('/archived_YouthAss/' . $item->id) }}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        <a href="" class="btn btn-warning"><i
                                                                                class="ti-pencil"></i></a>
                                                                        <a href="{{ url('/archived_YouthCoop/' . $item->id) }}"
                                                                            class="btn btn-danger"><i
                                                                                class="ti-trash"></i></a>
                                                                    </td>
                                                                </tr>
