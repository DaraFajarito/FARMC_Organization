            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="main-header">
                        ...
                        <br>
                        <a href="{{ url ('/FOform2GenInfo1') }}" class="btn btn-secondary"> <i class="icon-arrow-left"></i> Back</a>
                    </div>
                </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 20px;">
                                        ...
                                        <div class="form-radio">
                                            <div class="radio">
                                                <div class="col-md-3">
                                                    <label>
                                                        <input type="radio" name="radio" /><i class="helper"></i>Institutional
                                                    </label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>
                                                        <input type="radio" name="radio" /><i class="helper"></i>Occupational
                                                    </label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>
                                                        <input type="radio" name="radio" /><i class="helper"></i>Residential
                                                    </label>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>
                                                        <input type="radio" name="radio" /><i class="helper"></i>Associational
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="grid-material bg-general">b. &nbsp; Composition of Membership:</div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 20px;">
                                        <table class="table table-bordered smaller-font">
                                            <thead>
                                                <tr>
                                                    <th scope="col" style="text-align: center;" colspan="1"></th>
                                                    <th scope="col" style="text-align: center;" colspan="3">For Primary</th>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;"><input id="" type="text" class="form-control" style="width: 100px; margin: auto;"></td>
                                                    <td style="text-align: center;"><input id="" type="text" class="form-control" style="width: 100px; margin: auto;"></td>
                                                    <td style="text-align: center;"><input id="" type="text" class="form-control" style="width: 100px; margin: auto;"></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-md-12">
                                        <div class="grid-material bg-general">c. &nbsp; Number of Employees:</div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered smaller-font">
                                            <thead>
                                                <tr>
                                                    <th scope="col" style="text-align: center;" colspan="1"></th>
                                                    <th scope="col" style="text-align: center;" colspan="3">Current Year</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col" style="text-align: center;">Number of Employees</th>
                                                    <th scope="col" style="text-align: center;">Male</th>
                                                    <th scope="col" style="text-align: center;"></th>
                                                    <th scope="col" style="text-align: center;">Total</th>
                                                </tr>
