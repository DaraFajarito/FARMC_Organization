                        ...
                        <div class="card-block">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group m-r-15">
                                        ...
                                        <div> <!-- Added a margin top to create space -->
                                            <label style="font-size: smaller;"><b>4.3.1 Membership Committee
                                                </b></label>
                                        </div>
                                        ...
                                        <div> <!-- Added a margin top to create space -->
                                            <label style="font-size: smaller;"><b>4.3.2 Committee on Education and
                                                    Research </b></label>
                                        </div>
                                        ...
                                        <div> <!-- Added a margin top to create space -->
                                            <label style="font-size: smaller;"><b>4.3.5 Others: please
                                                    specify</b></label>
                                        </div>
                            ...
                            <div class="col-md-12 text-right">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#confirmationModal">SUBMIT <i class="icon-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
